...
export const TopFilter: React.FC<TopFilterProps> = ({
  ...
  className="absolute left-1/2 -translate-x-1/2 bottom-[-6.5rem] sm:bottom-[-8rem] md:bottom-[-2.5rem] lg:bottom-[-3rem]
             w-[90%] max-w-4xl bg-white shadow-md rounded-md
...
>
    <h1
    className="flex-1 sm:flex-none w-full sm:w-auto text-PRIMEblue uppercase text-sm font-semibold py-2 px-5 rounded-md"
  >
    Search Properties:
  </h1>
  <input
...
export const Filters: React.FC<FiltersProps> = ({
  ...
  return (
    <aside className="text-xs text-black/90 space-y-6">
      {/* Lease Type */}
      <div>
        <h3 className="font-normal mb-2">Lease Type</h3>
        <div className="flex flex-col space-y-1 border-b border-gray-300 pb-3">
          {leaseTypes.map((type) => (
      ...
      {/* Property Type */}
      <div>
        <h3 className="font-normal mb-2">Property Type</h3>
        <div className="flex flex-col space-y-1 border-b border-gray-300 pb-3">
      ...
      {/* Location */}
      <div>
        <h3 className="font-normal mb-2">Location</h3>
