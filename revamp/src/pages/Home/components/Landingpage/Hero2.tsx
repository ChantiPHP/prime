...
<header className="relative w-full">
  <div className="aspect-[16/9] sm:aspect-[16/8] md:aspect-[16/7] lg:aspect-[16/6] overflow-hidden">
    <video
  ...
  <section className=" text-PRIMEblack py-6 px-4 sm:px-6 text-center mt-2 sm:mt-4">
